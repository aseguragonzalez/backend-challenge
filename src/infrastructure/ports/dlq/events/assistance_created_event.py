...
from src.seedwork.infrastructure.queues.exceptions.unrecoverable_error import UnrecoverableError


@dataclass(frozen=True, init=False)
class AssistanceCreatedEvent(Event):
    def __init__(
        self,
        ...
        version: str = "1.0",
        type: str = "assistance_request_created",
    ):
    ...
    @classmethod
    def from_event(cls, event: Event) -> "AssistanceCreatedEvent":
        return cls(
