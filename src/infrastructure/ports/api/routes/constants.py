...
requests_endpoint_definition: dict[str, Any] = {
  ...
  "responses": {
      ...
      status.HTTP_401_UNAUTHORIZED: {
          "description": "The current request requires authentication."
      },
      status.HTTP_403_FORBIDDEN: {
          "description": "The current request requires authorization."
      },
      ...
      status.HTTP_500_INTERNAL_SERVER_ERROR: {
          "description": "An internal server error was produced."
      },
    },
}
